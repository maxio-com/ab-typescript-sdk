...
| `paymentMethod` | [`InvoiceEventInvoiceEventPaymentMethod \| undefined`](../../doc/models/containers/invoice-event-invoice-event-payment-method.md) | Optional | This is a container for one-of cases. |
...
| `creditNoteAttributes` | [`CreditNoteInvoiceEvent \| undefined`](../../doc/models/credit-note-invoice-event.md) | Optional | - |
