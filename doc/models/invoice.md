...
| `customer` | [`InvoiceCustomer \| undefined`](../../doc/models/invoice-customer.md) | Optional | Information about the customer who is owner or recipient of the invoiced subscription. |
...
| `brandingThemeId` | `number \| null \| undefined` | Optional | The ID of the Branding Theme associated with this invoice. This value represents the Branding Theme used for invoice theming, such as themed invoice rendering. Available only when Branding Themes are enabled for the site. |

## Example

```ts
import { Invoice } from '@maxio-com/advanced-billing-sdk';
