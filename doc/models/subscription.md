...
| `reasonCode` | `string \| null \| undefined` | Optional | The churn reason code associated to a canceled subscription. |
...
| `currentBillingAmountInCents` | `bigint \| undefined` | Optional | The balance in cents plus the estimated renewal amount in cents. Returned ONLY for the readSubscription operation as it's a compute intensive operation. |
...
| `reference` | `string \| null \| undefined` | Optional | The reference value (provided by your app) for the subscription itself. |
