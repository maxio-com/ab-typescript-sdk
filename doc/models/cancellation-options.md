...
| `scheduledCancellationAt` | `string \| null \| undefined` | Optional | Schedules the cancellation on the provided date. This option is not applicable for prepaid subscriptions. To use this option, the Schedule Subscription Cancellation feature must be enabled on your site. |
...
```ts
import { CancellationOptions } from '@maxio-com/advanced-billing-sdk';
