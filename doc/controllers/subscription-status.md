...
|  --- | --- | --- |
| 422 | Unprocessable Entity (WebDAV) | [`SubscriptionsRetryJson422Error`](../../doc/models/subscriptions-retry-json-422-error.md) |
...
async resumeSubscription(
  subscriptionId: string,
  calendarBillingResumptionCharge?: ResumptionChargeEnum,
  requestOptions?: RequestOptions
): Promise<ApiResponse<SubscriptionResponse>>
```
...
|  --- | --- | --- | --- |
| `subscriptionId` | `string` | Template, Required | The Chargify id of the subscription |
| `calendarBillingResumptionCharge` | [`ResumptionChargeEnum \| undefined`](../../doc/models/resumption-charge-enum.md) | Query, Optional | (For calendar billing subscriptions only) The way that the resumed subscription's charge should be handled<br>**Default**: `ResumptionChargeEnum.Prorated` |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
...
|  --- | --- | --- | --- |
| `subscriptionId` | `string` | Template, Required | The Chargify id of the subscription |
| `body` | [`PauseRequest \| undefined`](../../doc/models/pause-request.md) | Body, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |
