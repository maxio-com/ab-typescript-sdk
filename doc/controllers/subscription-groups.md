...
try {
  const response = await subscriptionGroupsController.signupWithSubscriptionGroup(body);
...
try {
  const response = await subscriptionGroupsController.createSubscriptionGroup(body);
...
try {
  const response = await subscriptionGroupsController.listSubscriptionGroups(collect);
...
try {
  const response = await subscriptionGroupsController.readSubscriptionGroup(
    uid,
    include
  );
...
try {
  const response = await subscriptionGroupsController.updateSubscriptionGroupMembers(
    uid,
    body
  );
...
try {
  const response = await subscriptionGroupsController.deleteSubscriptionGroup(uid);
...
try {
  const response = await subscriptionGroupsController.findSubscriptionGroup(subscriptionId);
...
try {
  const response = await subscriptionGroupsController.addSubscriptionToGroup(
    subscriptionId,
    body
  );
...
try {
  const response = await subscriptionGroupsController.removeSubscriptionFromGroup(subscriptionId);
