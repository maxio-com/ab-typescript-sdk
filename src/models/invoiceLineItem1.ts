...
import {
  ComponentCostData1,
  componentCostData1Schema,
} from './componentCostData1';
...
export interface InvoiceLineItem1 {
  ...
  hide?: boolean;
  componentCostData?: ComponentCostData1;
...
export const invoiceLineItem1Schema: Schema<InvoiceLineItem1> = expandoObject({
  ...
  componentCostData: [
    'component_cost_data',
    optional(lazy(() => componentCostData1Schema)),
  ],
