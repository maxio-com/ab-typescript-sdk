...
export interface PaymentMethodNestedDataInvoiceEvent {
  type?: string;
...
export const paymentMethodNestedDataInvoiceEventSchema: Schema<PaymentMethodNestedDataInvoiceEvent> = object(
  {
