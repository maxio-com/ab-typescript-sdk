...
import { Seller, sellerSchema } from './seller';
import { ShippingAddress, shippingAddressSchema } from './shippingAddress';

export interface CreditNoteInvoiceEvent {
...
export const creditNoteInvoiceEventSchema: Schema<CreditNoteInvoiceEvent> = object(
  {
    ...
    customer: ['customer', optional(lazy(() => customerCreditNoteSchema))],
    billingAddress: [
      'billing_address',
    ...
    discounts: [
      'discounts',
      optional(array(lazy(() => invoiceDiscountSchema))),
    ],
