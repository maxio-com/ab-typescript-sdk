...
export type SubscriptionSnapDay = number | SnapDay;

export const subscriptionSnapDaySchema: Schema<SubscriptionSnapDay> = oneOf([
  number(),
  snapDaySchema,
]);

export namespace SubscriptionSnapDay {
  /**
