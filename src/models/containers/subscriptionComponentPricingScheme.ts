...
export type SubscriptionComponentPricingScheme = PricingScheme;

export const subscriptionComponentPricingSchemeSchema: Schema<SubscriptionComponentPricingScheme> = oneOf(
  [pricingSchemeSchema]
);

export namespace SubscriptionComponentPricingScheme {
  /**
