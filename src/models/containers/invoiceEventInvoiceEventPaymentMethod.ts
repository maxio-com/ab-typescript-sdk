...
export type InvoiceEventInvoiceEventPaymentMethod = PaymentMethodApplePayType | PaymentMethodBankAccountType | PaymentMethodCreditCardType | PaymentMethodExternalType | PaymentMethodPaypalType;

export const invoiceEventInvoiceEventPaymentMethodSchema: Schema<InvoiceEventInvoiceEventPaymentMethod> = oneOf(
  [
    paymentMethodApplePayTypeSchema,
    paymentMethodBankAccountTypeSchema,
    paymentMethodCreditCardTypeSchema,
...
export namespace InvoiceEventInvoiceEventPaymentMethod {
  /**
