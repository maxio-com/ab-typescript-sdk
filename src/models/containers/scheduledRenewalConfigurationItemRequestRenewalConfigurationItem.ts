...
export type ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem =
  | ScheduledRenewalItemRequestBodyComponent
  | ScheduledRenewalItemRequestBodyProduct;

export const scheduledRenewalConfigurationItemRequestRenewalConfigurationItemSchema: Schema<ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem> = lazy(
  () =>
    oneOf([
      scheduledRenewalItemRequestBodyComponentSchema,
      scheduledRenewalItemRequestBodyProductSchema,
