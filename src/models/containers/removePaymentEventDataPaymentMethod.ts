...
export type RemovePaymentEventDataPaymentMethod = PaymentMethodApplePayType | PaymentMethodBankAccountType | PaymentMethodCreditCardType | PaymentMethodExternalType | PaymentMethodPaypalType;

export const removePaymentEventDataPaymentMethodSchema: Schema<RemovePaymentEventDataPaymentMethod> = oneOf(
  [
    paymentMethodApplePayTypeSchema,
    paymentMethodBankAccountTypeSchema,
    paymentMethodCreditCardTypeSchema,
...
export namespace RemovePaymentEventDataPaymentMethod {
  /**
