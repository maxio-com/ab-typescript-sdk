...
export type CreateInvoicePaymentAmount = string | number;

export const createInvoicePaymentAmountSchema: Schema<CreateInvoicePaymentAmount> = oneOf(
  [string(), number()]
);

export namespace CreateInvoicePaymentAmount {
  /**
