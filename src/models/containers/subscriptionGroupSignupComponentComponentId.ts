...
export const subscriptionGroupSignupComponentComponentIdSchema: Schema<SubscriptionGroupSignupComponentComponentId> = oneOf(
  [string(), number()]
);

export namespace SubscriptionGroupSignupComponentComponentId {
  /**
