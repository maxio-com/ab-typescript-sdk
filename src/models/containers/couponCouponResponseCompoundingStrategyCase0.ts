...
export type CouponCouponResponseCompoundingStrategyCase0 = CompoundingStrategy;

export const couponCouponResponseCompoundingStrategyCase0Schema: Schema<CouponCouponResponseCompoundingStrategyCase0> = oneOf(
  [compoundingStrategySchema]
);

export namespace CouponCouponResponseCompoundingStrategyCase0 {
  /**
