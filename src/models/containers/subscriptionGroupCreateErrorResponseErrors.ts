...
export type SubscriptionGroupCreateErrorResponseErrors = SubscriptionGroupMembersArrayError | SubscriptionGroupSingleError | string;
...
export namespace SubscriptionGroupCreateErrorResponseErrors {
  ...
  */
  export function isSubscriptionGroupMembersArrayError(value: unknown): value is SubscriptionGroupMembersArrayError {
    const validationResult = validateAndMap(value, subscriptionGroupMembersArrayErrorSchema);
  ...
  */
  export function isSubscriptionGroupSingleError(value: unknown): value is SubscriptionGroupSingleError {
    const validationResult = validateAndMap(value, subscriptionGroupSingleErrorSchema);
    return validationResult.errors === false;
  }
