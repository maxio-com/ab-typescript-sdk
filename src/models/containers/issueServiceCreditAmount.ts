...
export type IssueServiceCreditAmount = number | string;

export const issueServiceCreditAmountSchema: Schema<IssueServiceCreditAmount> = oneOf(
  [number(), string()]
);

export namespace IssueServiceCreditAmount {
  /**
