...
export type CreateInvoiceCouponAmount = string | number;

export const createInvoiceCouponAmountSchema: Schema<CreateInvoiceCouponAmount> = oneOf(
  [string(), number()]
);

export namespace CreateInvoiceCouponAmount {
  /**
