...
export namespace InvoiceEvent {
  ...
  */
  export function isApplyCreditNoteEvent(value: unknown): value is ApplyCreditNoteEvent {
  ...
  */
  export function isApplyDebitNoteEvent(value: unknown): value is ApplyDebitNoteEvent {
  ...
  */
  export function isApplyPaymentEvent(value: unknown): value is ApplyPaymentEvent {
  ...
  */
  export function isBackportInvoiceEvent(value: unknown): value is BackportInvoiceEvent {
  ...
  */
  export function isChangeChargebackStatusEvent(value: unknown): value is ChangeChargebackStatusEvent {
    const validationResult = validateAndMap(value, changeChargebackStatusEventSchema);
    return validationResult.errors === false;
  }
  ...
  */
  export function isChangeInvoiceCollectionMethodEvent(value: unknown): value is ChangeInvoiceCollectionMethodEvent {
    const validationResult = validateAndMap(value, changeInvoiceCollectionMethodEventSchema);
    return validationResult.errors === false;
  }
  ...
  */
  export function isChangeInvoiceStatusEvent(value: unknown): value is ChangeInvoiceStatusEvent {
    const validationResult = validateAndMap(value, changeInvoiceStatusEventSchema);
    return validationResult.errors === false;
  }
  ...
  */
  export function isCreateCreditNoteEvent(value: unknown): value is CreateCreditNoteEvent {
  ...
  */
  export function isCreateDebitNoteEvent(value: unknown): value is CreateDebitNoteEvent {
  ...
  */
  export function isFailedPaymentEvent(value: unknown): value is FailedPaymentEvent {
  ...
  */
  export function isIssueInvoiceEvent(value: unknown): value is IssueInvoiceEvent {
  ...
  */
  export function isRefundInvoiceEvent(value: unknown): value is RefundInvoiceEvent {
  ...
  */
  export function isRemovePaymentEvent(value: unknown): value is RemovePaymentEvent {
  ...
  */
  export function isVoidInvoiceEvent(value: unknown): value is VoidInvoiceEvent {
  ...
  */
  export function isVoidRemainderEvent(value: unknown): value is VoidRemainderEvent {
