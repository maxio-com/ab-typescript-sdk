...
export type OnOffComponentUnitPrice = string | number;

export const onOffComponentUnitPriceSchema: Schema<OnOffComponentUnitPrice> = oneOf(
  [string(), number()]
);

export namespace OnOffComponentUnitPrice {
  /**
