...
export type UpdateInvoiceItemQuantity = number | string;

export const updateInvoiceItemQuantitySchema: Schema<UpdateInvoiceItemQuantity> = oneOf(
  [number(), string()]
);

export namespace UpdateInvoiceItemQuantity {
  /**
