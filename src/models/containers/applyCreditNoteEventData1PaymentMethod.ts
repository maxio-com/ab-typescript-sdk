...
export namespace ApplyCreditNoteEventData1PaymentMethod {
  ...
  */
  export function isPaymentMethodApplePay(value: unknown): value is PaymentMethodApplePay {
  ...
  */
  export function isPaymentMethodBankAccount(value: unknown): value is PaymentMethodBankAccount {
    const validationResult = validateAndMap(value, paymentMethodBankAccountSchema);
    return validationResult.errors === false;
  }
  ...
  */
  export function isPaymentMethodCreditCard(value: unknown): value is PaymentMethodCreditCard {
    const validationResult = validateAndMap(value, paymentMethodCreditCardSchema);
    return validationResult.errors === false;
  }
  ...
  */
  export function isPaymentMethodExternal(value: unknown): value is PaymentMethodExternal {
  ...
  */
  export function isPaymentMethodPaypal(value: unknown): value is PaymentMethodPaypal {
