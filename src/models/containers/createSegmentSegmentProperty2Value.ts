...
export type CreateSegmentSegmentProperty2Value = string | number | boolean;

export const createSegmentSegmentProperty2ValueSchema: Schema<CreateSegmentSegmentProperty2Value> = oneOf(
