...
export type PriceEndingQuantity = number | string;

export const priceEndingQuantitySchema: Schema<PriceEndingQuantity> = oneOf([
  number(),
  string(),
]);

export namespace PriceEndingQuantity {
  /**
