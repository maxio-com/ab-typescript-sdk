...
export type OnOffComponentPricingScheme = PricingScheme;

export const onOffComponentPricingSchemeSchema: Schema<OnOffComponentPricingScheme> = oneOf(
  [pricingSchemeSchema]
);

export namespace OnOffComponentPricingScheme {
  /**
