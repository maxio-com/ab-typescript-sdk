...
export type CreateComponentPriceUnitPrice = string | number;

export const createComponentPriceUnitPriceSchema: Schema<CreateComponentPriceUnitPrice> = oneOf(
  [string(), number()]
);

export namespace CreateComponentPriceUnitPrice {
  /**
