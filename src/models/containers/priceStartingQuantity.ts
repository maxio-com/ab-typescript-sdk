...
export type PriceStartingQuantity = number | string;

export const priceStartingQuantitySchema: Schema<PriceStartingQuantity> = oneOf(
  [number(), string()]
);

export namespace PriceStartingQuantity {
  /**
