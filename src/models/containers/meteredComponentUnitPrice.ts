...
export type MeteredComponentUnitPrice = string | number;

export const meteredComponentUnitPriceSchema: Schema<MeteredComponentUnitPrice> = oneOf(
  [string(), number()]
);

export namespace MeteredComponentUnitPrice {
  /**
