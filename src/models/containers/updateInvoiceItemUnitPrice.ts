...
export type UpdateInvoiceItemUnitPrice = number | string;

export const updateInvoiceItemUnitPriceSchema: Schema<UpdateInvoiceItemUnitPrice> = oneOf(
  [number(), string()]
);

export namespace UpdateInvoiceItemUnitPrice {
  /**
