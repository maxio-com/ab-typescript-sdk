...
export type ListCustomersDirection = SortingDirection;

export const listCustomersDirectionSchema: Schema<ListCustomersDirection> = oneOf(
  [sortingDirectionSchema]
);

export namespace ListCustomersDirection {
  /**
