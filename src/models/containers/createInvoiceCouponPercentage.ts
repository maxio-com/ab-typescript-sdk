...
export type CreateInvoiceCouponPercentage = string | number;

export const createInvoiceCouponPercentageSchema: Schema<CreateInvoiceCouponPercentage> = oneOf(
  [string(), number()]
);

export namespace CreateInvoiceCouponPercentage {
  /**
