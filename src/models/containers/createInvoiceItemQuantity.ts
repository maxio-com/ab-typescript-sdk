...
export type CreateInvoiceItemQuantity = number | string;

export const createInvoiceItemQuantitySchema: Schema<CreateInvoiceItemQuantity> = oneOf(
  [number(), string()]
);

export namespace CreateInvoiceItemQuantity {
  /**
