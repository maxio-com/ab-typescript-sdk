...
export type CreateInvoiceCouponProductFamilyId = string | number;

export const createInvoiceCouponProductFamilyIdSchema: Schema<CreateInvoiceCouponProductFamilyId> = oneOf(
  [string(), number()]
);
