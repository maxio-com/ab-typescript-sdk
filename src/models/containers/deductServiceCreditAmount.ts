...
export type DeductServiceCreditAmount = string | number;

export const deductServiceCreditAmountSchema: Schema<DeductServiceCreditAmount> = oneOf(
  [string(), number()]
);

export namespace DeductServiceCreditAmount {
  /**
