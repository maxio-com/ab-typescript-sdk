...
export type PricePointExpirationIntervalUnit = IntervalUnit;

export const pricePointExpirationIntervalUnitSchema: Schema<PricePointExpirationIntervalUnit> = oneOf(
  [intervalUnitSchema]
);

export namespace PricePointExpirationIntervalUnit {
  /**
