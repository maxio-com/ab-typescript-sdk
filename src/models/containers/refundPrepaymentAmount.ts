...
export type RefundPrepaymentAmount = string | number;

export const refundPrepaymentAmountSchema: Schema<RefundPrepaymentAmount> = oneOf(
  [string(), number()]
);

export namespace RefundPrepaymentAmount {
  /**
