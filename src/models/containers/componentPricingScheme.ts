...
export type ComponentPricingScheme = PricingScheme;

export const componentPricingSchemeSchema: Schema<ComponentPricingScheme> = oneOf(
  [pricingSchemeSchema]
);

export namespace ComponentPricingScheme {
  /**
