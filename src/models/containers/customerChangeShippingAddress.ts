...
export type CustomerChangeShippingAddress = AddressChange;

export const customerChangeShippingAddressSchema: Schema<CustomerChangeShippingAddress> = oneOf(
  [addressChangeSchema]
);

export namespace CustomerChangeShippingAddress {
  /**
