...
export type CreateUsageComponentId = number | string;

export const createUsageComponentIdSchema: Schema<CreateUsageComponentId> = oneOf(
  [number(), string()]
);

export namespace CreateUsageComponentId {
  /**
