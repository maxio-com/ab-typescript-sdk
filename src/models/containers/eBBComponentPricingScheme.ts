...
export type EBBComponentPricingScheme = PricingScheme;

export const eBBComponentPricingSchemeSchema: Schema<EBBComponentPricingScheme> = oneOf(
  [pricingSchemeSchema]
);

export namespace EBBComponentPricingScheme {
  /**
