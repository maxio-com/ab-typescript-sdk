...
import { DiscountTypeEnum, discountTypeEnumSchema } from './discountTypeEnum';
import {
  RecurringSchemeEnum,
  recurringSchemeEnumSchema,
} from './recurringSchemeEnum';
...
export interface Coupon {
  ...
  recurring?: boolean;
  recurringScheme?: RecurringSchemeEnum;
...
export const couponSchema: Schema<Coupon> = object({
  ...
  recurringScheme: ['recurring_scheme', optional(recurringSchemeEnumSchema)],
  ...
  discountType: ['discount_type', optional(discountTypeEnumSchema)],
