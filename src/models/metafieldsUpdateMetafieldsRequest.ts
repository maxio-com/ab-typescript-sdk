...
export interface MetafieldsUpdateMetafieldsRequest {
  currentName?: string;
  name?: string;
...
export const metafieldsUpdateMetafieldsRequestSchema: Schema<MetafieldsUpdateMetafieldsRequest> = object(
  {
