...
import { InvoiceLineItem1, invoiceLineItem1Schema } from './invoiceLineItem1';
...
export const invoice1Schema: Schema<Invoice1> = expandoObject({
  ...
  lineItems: [
    'line_items',
    optional(array(lazy(() => invoiceLineItem1Schema))),
  ],
