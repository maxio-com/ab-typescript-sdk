...
/**
 * Enum for WebhookSubscriptionEnum
 */
export enum WebhookSubscriptionEnum {
...
/**
 * Schema for WebhookSubscriptionEnum
 */
export const webhookSubscriptionEnumSchema: Schema<WebhookSubscriptionEnum> = stringEnum(WebhookSubscriptionEnum);
