...
import {
  ...
  invoiceEventInvoiceEventPaymentMethodSchema,
} from './containers/invoiceEventInvoiceEventPaymentMethod';
import {
  CreditNoteInvoiceEvent,
  creditNoteInvoiceEventSchema,
} from './creditNoteInvoiceEvent';
import {
...
export interface InvoiceEventInvoiceEvent {
  ...
  paymentMethod?: InvoiceEventInvoiceEventPaymentMethod;
  ...
  applyCredit?: boolean;
  creditNoteAttributes?: CreditNoteInvoiceEvent;
...
export const invoiceEventInvoiceEventSchema: Schema<InvoiceEventInvoiceEvent> = object(
  {
    ...
    paymentMethod: [
      'payment_method',
      optional(lazy(() => invoiceEventInvoiceEventPaymentMethodSchema)),
    ],
    ...
    creditNoteAttributes: [
      ...
      optional(lazy(() => creditNoteInvoiceEventSchema)),
    ],
