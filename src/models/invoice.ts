...
import {
  ...
  invoiceConsolidationLevelEnumSchema,
} from './invoiceConsolidationLevelEnum';
...
export interface Invoice {
   ...
   */
  consolidationLevel?: InvoiceConsolidationLevelEnum;
...
export const invoiceSchema: Schema<Invoice> = object({
  ...
  consolidationLevel: [
    'consolidation_level',
    optional(invoiceConsolidationLevelEnumSchema),
  ],
