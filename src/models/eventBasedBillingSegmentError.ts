...
import { dict, expandoObject, optional, Schema, unknown } from '../schema.js';
...
export const eventBasedBillingSegmentErrorSchema: Schema<EventBasedBillingSegmentError> = expandoObject(
