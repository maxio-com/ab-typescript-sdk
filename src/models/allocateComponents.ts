...
import {
  ...
  legacyPaymentCollectionMethodEnumSchema,
} from './legacyPaymentCollectionMethodEnum';
...
export interface AllocateComponents {
  ...
  paymentCollectionMethod?: LegacyPaymentCollectionMethodEnum;
}
...
export const allocateComponentsSchema: Schema<AllocateComponents> = object({
  ...
  paymentCollectionMethod: [
    ...
    optional(legacyPaymentCollectionMethodEnumSchema),
  ],
});
