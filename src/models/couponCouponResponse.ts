...
import {
  ...
  couponCouponResponseCompoundingStrategySchema,
} from './containers/couponCouponResponseCompoundingStrategy';
...
export interface CouponCouponResponse {
  id?: number;
  name?: string;
  code?: string;
  description?: string;
  ...
  stackable?: boolean;
  compoundingStrategy?: CouponCouponResponseCompoundingStrategy;
...
export const couponCouponResponseSchema: Schema<CouponCouponResponse> = object({
  ...
  compoundingStrategy: [
    ...
    optional(lazy(() => couponCouponResponseCompoundingStrategySchema)),
  ],
