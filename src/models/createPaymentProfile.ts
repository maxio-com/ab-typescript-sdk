...
import {
  ...
  createPaymentProfileVaultEnumSchema,
} from './createPaymentProfileVaultEnum';
import { PaymentTypeEnum, paymentTypeEnumSchema } from './paymentTypeEnum';
...
export interface CreatePaymentProfile {
  ...
  currentVault?: CreatePaymentProfileVaultEnum;
...
export const createPaymentProfileSchema: Schema<CreatePaymentProfile> = object({
  ...
  currentVault: [
    'current_vault',
    optional(createPaymentProfileVaultEnumSchema),
  ],
