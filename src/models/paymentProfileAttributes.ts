...
import { CurrentVaultEnum, currentVaultEnumSchema } from './currentVaultEnum';
...
export const paymentProfileAttributesSchema: Schema<PaymentProfileAttributes> = object(
  {
    ...
    currentVault: ['current_vault', optional(currentVaultEnumSchema)],
