...
import {
  ...
  subscriptionDateFieldEnumSchema,
} from '../models/subscriptionDateFieldEnum';
import {
  SubscriptionIncludeEnum,
  subscriptionIncludeEnumSchema,
} from '../models/subscriptionIncludeEnum';
import {
...
import {
  ...
  subscriptionPurgeTypeEnumSchema,
} from '../models/subscriptionPurgeTypeEnum';
import {
...
import {
  ...
  subscriptionSortEnumSchema,
} from '../models/subscriptionSortEnum';
import {
...
export class SubscriptionsController extends BaseController {
  ...
  async listSubscriptions({
    ...
    const mapped = req.prepareArgs({
      ...
      sort: [sort, optional(subscriptionSortEnumSchema)],
    });
  ...
  async readSubscription(
    ...
    const mapped = req.prepareArgs({
      subscriptionId: [subscriptionId, string()],
      include: [include, optional(array(subscriptionIncludeEnumSchema))],
    });
  ...
  async purgeSubscription(
    ...
    const mapped = req.prepareArgs({
      subscriptionId: [subscriptionId, string()],
      ack: [ack, optional(number())],
      cascade: [cascade, optional(array(subscriptionPurgeTypeEnumSchema))],
    });
  ...
  async deleteCouponFromSubscription(
    ...
    req.throwOn(422, SubscriptionsRemoveCouponJson422Error, 'Unprocessable Entity (WebDAV)');
  ...
  async activateSubscription(
    ...
    req.throwOn(400, SubscriptionsActivateJson400Error, 'Bad Request');
    return req.callAsJson(subscriptionResponseSchema, requestOptions);
  }
}
