...
import { EventTypeEnum, eventTypeEnumSchema } from '../models/eventTypeEnum';
import {
  ListEventsDateFieldEnum,
  listEventsDateFieldEnumSchema,
} from '../models/listEventsDateFieldEnum';
...
export class EventsController extends BaseController {
   ...
   *                                                  page of results is displayed. The page parameter specifies a page
   ...
   *                                                  date_field. Returns components with a timestamp at or after
   ...
   *                                                  to filter the date_field. Returns components with a timestamp at
  ...
  async listEvents(
    ...
    const mapped = req.prepareArgs({
      ...
      filter: [filter, optional(array(eventTypeEnumSchema))],
      dateField: [dateField, optional(listEventsDateFieldEnumSchema)],
