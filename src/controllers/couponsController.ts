...
} from '../errors/couponsValidateJson404Error';
...
export class CouponsController extends BaseController {
   ...
   * @param filterDateField                The type of filter you would like to apply to your
   *                                                             search. Use in query `filter[date_field]=created_at`.
   * @param filterEndDate                  The end date (format YYYY-MM-DD) with which to filter
   *                                                             the date_field. Returns coupons with a timestamp up to
   *                                                             and including 11:59:59PM in your site’s time zone on
   *                                                             the date specified. Use in query
   *                                                             `filter[date_field]=2011-12-15`.
   * @param filterEndDatetime              The end date and time (format YYYY-MM-DD HH:MM:SS)
   *                                                             with which to filter the date_field. Returns coupons
   *                                                             with a timestamp at or before exact time provided in
   *                                                             query. You can specify timezone in query - otherwise
   *                                                             your site's time zone will be used. If provided, this
   *                                                             parameter will be used instead of end_date. Use in
   *                                                             query `?filter[end_datetime]=2011-12-1T10:15:30+01:00`.
   * @param filterStartDate                The start date (format YYYY-MM-DD) with which to
   *                                                             filter the date_field. Returns coupons with a
   ...
   * @param filterStartDatetime            The start date and time (format YYYY-MM-DD HH:MM:SS)
   *                                                             with which to filter the date_field. Returns coupons
   *                                                             with a timestamp at or after exact time provided in
   *                                                             query. You can specify timezone in query - otherwise
   *                                                             your site's time zone will be used. If provided, this
   *                                                             parameter will be used instead of start_date. Use in
   *                                                             query `filter[start_datetime]=2011-12-19T10:15:30+01:
   *                                                             00`.
   ...
   *                                                             currencies at the site level, you can optionally pass
   *                                                             the `?currency_prices=true` query param to include an
   *                                                             array of currency price data in the response. Use in
  ...
  async listCouponsForProductFamily(
    ...
    req.appendTemplatePath`/product_families/${mapped.productFamilyId}/coupons.json`;
    return req.callAsJson(array(couponSchema), requestOptions);
  }
   ...
   *                                                             recommend using filter[date_field] instead to achieve
   *                                                             the same result. The type of filter you would like to
   *                                                             apply to your search.
   * @param startDate                      The field was deprecated: on January 20, 2022. We
   *                                                             recommend using filter[start_date] instead to achieve
   *                                                             the same result. The start date (format YYYY-MM-DD)
   *                                                             with which to filter the date_field. Returns coupons
   ...
   *                                                             recommend using filter[end_date] instead to achieve
   *                                                             the same result. The end date (format YYYY-MM-DD) with
   ...
   *                                                             recommend using filter[start_datetime] instead to
   *                                                             achieve the same result. The start date and time
   ...
   *                                                             recommend using filter[end_datetime] instead to
   ...
   *                                                             your site's time zone will be used. If provided, this
   *                                                             parameter will be used instead of end_date. Use in
   *                                                             query `filter[end_datetime]=2011-12-19T10:15:30+01:00`.
   * @param filterStartDate                The start date (format YYYY-MM-DD) with which to
   *                                                             filter the date_field. Returns coupons with a
   *                                                             timestamp at or after midnight (12:00:00 AM) in your
   *                                                             site’s time zone on the date specified. Use in query
   ...
   *                                                             00`.
   * @param filterDateField                The type of filter you would like to apply to your
   *                                                             search. Use in query `filter[date_field]=updated_at`.
   * @param filterUseSiteExchangeRate      Allows fetching coupons with matching
   *                                                             use_site_exchange_rate based on provided value. Use in
   *                                                             query `filter[use_site_exchange_rate]=true`.
   * @return Response from the API call
  ...
  async validateCoupon(
    ...
    req.query('code', mapped.code);
    req.query('product_family_id', mapped.productFamilyId);
    req.throwOn(404, CouponsValidateJson404Error, 'Not Found');
    return req.callAsJson(couponResponseSchema, requestOptions);
  }
