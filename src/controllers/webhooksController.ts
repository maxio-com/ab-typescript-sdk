...
import {
  WebhookOrderEnum,
  webhookOrderEnumSchema,
} from '../models/webhookOrderEnum';
import {
  WebhookResponse,
...
import {
  WebhookStatusEnum,
  webhookStatusEnumSchema,
} from '../models/webhookStatusEnum';
...
export class WebhooksController extends BaseController {
   ...
   * @param sinceDate    Format YYYY-MM-DD. Returns Webhooks with the created_at date greater
   *                                          than or equal to the one specified.
   * @param untilDate    Format YYYY-MM-DD. Returns Webhooks with the created_at date less than
  ...
  async listWebhooks(
    ...
    const mapped = req.prepareArgs({
      status: [status, optional(webhookStatusEnumSchema)],
      sinceDate: [sinceDate, optional(string())],
      untilDate: [untilDate, optional(string())],
      page: [page, optional(number())],
      perPage: [perPage, optional(number())],
      order: [order, optional(webhookOrderEnumSchema)],
