...
} from '../errors/subscriptionsAllocationsPreviewJson422Error';
import {
  SubscriptionsComponentsAllocationsAllocationIdJson422Error,
} from '../errors/subscriptionsComponentsAllocationsAllocationIdJson422Error';
import {
  SubscriptionsPricePointsJson422Error,
} from '../errors/subscriptionsPricePointsJson422Error';
import {
  AllocateComponents,
...
import {
  IncludeNotNullEnum,
  includeNotNullEnumSchema,
} from '../models/includeNotNullEnum';
import {
  ListSubscriptionComponentsDateFieldEnum,
  listSubscriptionComponentsDateFieldEnumSchema,
} from '../models/listSubscriptionComponentsDateFieldEnum';
import {
  ListSubscriptionComponentsIncludeEnum,
  listSubscriptionComponentsIncludeEnumSchema,
} from '../models/listSubscriptionComponentsIncludeEnum';
import {
...
import {
  ...
  listSubscriptionComponentsSortEnumSchema,
} from '../models/listSubscriptionComponentsSortEnum';
import {
  ListSubscriptionComponentsSubscriptionDateFieldEnum,
  listSubscriptionComponentsSubscriptionDateFieldEnumSchema,
} from '../models/listSubscriptionComponentsSubscriptionDateFieldEnum';
import {
...
import {
  ...
  subscriptionStateEnumSchema,
} from '../models/subscriptionStateEnum';
import {
...
export class SubscriptionComponentsController extends BaseController {
  ...
  async listSubscriptionComponents(
    ...
    const mapped = req.prepareArgs({
      ...
      dateField: [
        dateField,
        optional(listSubscriptionComponentsDateFieldEnumSchema),
      ],
      direction: [
        direction,
      ...
      pricePointIds: [pricePointIds, optional(includeNotNullEnumSchema)],
      productFamilyIds: [productFamilyIds, optional(array(number()))],
      sort: [sort, optional(listSubscriptionComponentsSortEnumSchema)],
      startDate: [startDate, optional(string())],
      startDatetime: [startDatetime, optional(string())],
      include: [include, optional(listSubscriptionComponentsIncludeEnumSchema)],
  ...
  async updateSubscriptionComponentsPricePoints(
    ...
    req.throwOn(422, SubscriptionsPricePointsJson422Error, 'Unprocessable Entity (WebDAV)');
    return req.callAsJson(
      bulkComponentSPricePointAssignmentSchema,
      requestOptions
    );
  ...
  async previewAllocations(
    ...
    req.throwOn(422, SubscriptionsAllocationsPreviewJson422Error, 'Unprocessable Entity (WebDAV)');
  ...
  async updatePrepaidUsageAllocation(
    ...
    req.throwOn(422, SubscriptionsComponentsAllocationsAllocationIdJson422Error, 'Unprocessable Entity (WebDAV)');
   ...
   *                                                                                                    query
   *                                                                                                    `per_page=200`.
   * @param sort                                 The attribute
   *                                                                                                    by which to
   *                                                                                                    sort. Use in
   *                                                                                                    query:
   *                                                                                                    `sort=updated_a
   *                                                                                                    t`.
   * @param direction                            Controls the
   *                                                                                                    order in which
   *                                                                                                    results are
   *                                                                                                    returned. Use
   *                                                                                                    in query
   *                                                                                                    `direction=asc`.
   * @param dateField                            The type of
   *                                                                                                    filter you'd
   *                                                                                                    like to apply
   *                                                                                                    to your search.
   *                                                                                                    Use in query:
   ...
   *                                                                                                    `include=subscr
   *                                                                                                    iption`.
   * @param filterUseSiteExchangeRate            Allows
   *                                                                                                    fetching
   *                                                                                                    components
   *                                                                                                    allocation with
   *                                                                                                    matching
   ...
   *                                                                                                    `filter[currenc
   *                                                                                                    ies]=USD,EUR`.
   * @param filterSubscriptionStates             Allows
   *                                                                                                    fetching
   *                                                                                                    components
   *                                                                                                    allocations
   *                                                                                                    that belong to
   ...
   *                                                                                                    canceled&includ
   *                                                                                                    e=subscription`.
   * @param filterSubscriptionDateField          The type of
   *                                                                                                    filter you'd
   *                                                                                                    like to apply
   *                                                                                                    to your search.
   *                                                                                                    To use this
   ...
   *                                                                                                    `include=subscr
   *                                                                                                    iption`.
   * @param filterSubscriptionStartDatetime      The start date
   *                                                                                                    and time
   *                                                                                                    (format YYYY-MM-
   *                                                                                                    DD HH:MM:SS)
   *                                                                                                    with which to
   ...
   *                                                                                                    `include=subscr
   *                                                                                                    iption`.
   * @param filterSubscriptionEndDatetime        The end date
   *                                                                                                    and time
   *                                                                                                    (format YYYY-MM-
   *                                                                                                    DD HH:MM:SS)
   *                                                                                                    with which to
  ...
  async listSubscriptionComponentsForSite(
    ...
    const mapped = req.prepareArgs({
      ...
      filterSubscriptionStates: [
        filterSubscriptionStates,
        optional(array(subscriptionStateEnumSchema)),
      ],
      filterSubscriptionDateField: [
        filterSubscriptionDateField,
        optional(listSubscriptionComponentsSubscriptionDateFieldEnumSchema),
      ],
