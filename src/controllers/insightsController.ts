...
} from '../errors/subscriptionsMrrJson400Error';
import {
...
export class InsightsController extends BaseController {
   ...
   * @param atTime                   Submit a timestamp in ISO8601 format to request MRR for a
  ...
  async listMrrPerSubscription(
    ...
    req.throwOn(400, SubscriptionsMrrJson400Error, 'Bad Request');
