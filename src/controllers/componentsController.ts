...
import {
  BasicDateFieldEnum,
  basicDateFieldEnumSchema,
} from '../models/basicDateFieldEnum';
import {
  ComponentKindPathEnum,
  componentKindPathEnumSchema,
} from '../models/componentKindPathEnum';
import {
...
import {
  ...
  listComponentsPricePointsIncludeEnumSchema,
} from '../models/listComponentsPricePointsIncludeEnum';
import {
...
} from '../models/pricePointTypeEnum';
import {
...
export class ComponentsController extends BaseController {
  ...
  async createComponent(
    ...
    const mapped = req.prepareArgs({
      ...
      componentKind: [componentKind, componentKindPathEnumSchema],
   ...
   *
   * @param dateField                      The type of filter you would like to apply to your
   *                                                             search.
   * @param startDate                      The start date (format YYYY-MM-DD) with which to
   *                                                             filter the date_field. Returns components with a
   ...
   *                                                             the date_field. Returns components with a timestamp up
   *                                                             to and including 11:59:59PM in your site’s time zone
   *                                                             on the date specified.
   * @param startDatetime                  The start date and time (format YYYY-MM-DD HH:MM:SS)
   *                                                             with which to filter the date_field. Returns
   *                                                             components with a timestamp at or after exact time
   ...
   *                                                             with which to filter the date_field. Returns
   *                                                             components with a timestamp at or before exact time
   *                                                             provided in query. You can specify timezone in query -
   *                                                             otherwise your site's time zone will be used. If
   *                                                             provided, this parameter will be used instead of
   *                                                             end_date.  optional
   ...
   *                                                             parameter specifies a page number of results to fetch.
   *                                                             You can start navigating through the pages to consume
   *                                                             the results. You do this by passing in a page
   ...
   *                                                             use_site_exchange_rate based on provided value (refers
   *                                                             to default price point). Use in query
  ...
  async listComponents(
    ...
    const mapped = req.prepareArgs({
      dateField: [dateField, optional(basicDateFieldEnumSchema)],
  ...
  async listComponentPricePoints(
    ...
    const mapped = req.prepareArgs({
      ...
      page: [page, optional(number())],
      perPage: [perPage, optional(number())],
      filterType: [filterType, optional(array(pricePointTypeEnumSchema))],
    });
  ...
  async listAllComponentPricePoints(
    ...
    const mapped = req.prepareArgs({
      filterDateField: [filterDateField, optional(basicDateFieldEnumSchema)],
      filterEndDate: [filterEndDate, optional(string())],
      filterEndDatetime: [filterEndDatetime, optional(string())],
      include: [include, optional(listComponentsPricePointsIncludeEnumSchema)],
      page: [page, optional(number())],
      perPage: [perPage, optional(number())],
      ...
      filterIds: [filterIds, optional(array(number()))],
      filterArchivedAt: [filterArchivedAt, optional(includeNotNullEnumSchema)],
    });
