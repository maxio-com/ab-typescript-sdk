...
export class ProductPricePointsController extends BaseController {
   ...
   * @param currencyPrices  (Optional) If you have defined multiple currencies
   *                                                                at the site level, you can pass ?
   *                                                                currency_prices=true to include an array of
   *                                                                currency price data in the response. If the product
   *                                                                price point is set to use_site_exchange_rate: true,
   *                                                                it will return pricing based on the current
   *                                                                exchange rate. If the flag is set to false, it will
   *                                                                return all of the defined prices for each currency.
   ...
   * @param currencyPrices  (Optional) If you have defined multiple currencies at
   *                                                             the site level, you can pass ?currency_prices=true to
   *                                                             include an array of currency price data in the
