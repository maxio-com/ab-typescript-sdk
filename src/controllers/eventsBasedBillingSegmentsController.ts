...
} from '../errors/componentsPricePointsSegmentsBulkJson422Error';
import {
  ComponentsPricePointsSegmentsBulkJson422Error2Error,
} from '../errors/componentsPricePointsSegmentsBulkJson422Error2Error';
import {
  ComponentsPricePointsSegmentsIdJson422Error,
} from '../errors/componentsPricePointsSegmentsIdJson422Error';
import {
  ComponentsPricePointsSegmentsJson422Error,
} from '../errors/componentsPricePointsSegmentsJson422Error';
import {
  ComponentsPricePointsSegmentsJson422Error2Error,
} from '../errors/componentsPricePointsSegmentsJson422Error2Error';
import {
  BulkCreateSegments,
...
export class EventsBasedBillingSegmentsController extends BaseController {
  ...
  async createSegment(
    ...
    req.throwOn(422, ComponentsPricePointsSegmentsJson422Error, 'Unprocessable Entity (WebDAV)');
  ...
  async listSegmentsForPricePoint(
    ...
    req.throwOn(403, ApiError, 'Forbidden');
    req.throwOn(404, ApiError, 'Not Found');
    req.throwOn(422, ComponentsPricePointsSegmentsJson422Error2Error, 'Unprocessable Entity (WebDAV)');
  ...
  async updateSegment(
    ...
    req.throwOn(403, ApiError, 'Forbidden');
    req.throwOn(404, ApiError, 'Not Found');
    req.throwOn(422, ComponentsPricePointsSegmentsIdJson422Error, 'Unprocessable Entity (WebDAV)');
    return req.callAsJson(segmentResponseSchema, requestOptions);
  }
  ...
  async createSegments(
    ...
    req.throwOn(403, ApiError, 'Forbidden');
    req.throwOn(404, ApiError, 'Not Found');
    req.throwOn(422, ComponentsPricePointsSegmentsBulkJson422Error, 'Unprocessable Entity (WebDAV)');
    return req.callAsJson(listSegmentsResponseSchema, requestOptions);
  }
  ...
  async updateSegments(
    ...
    req.throwOn(403, ApiError, 'Forbidden');
    req.throwOn(404, ApiError, 'Not Found');
    req.throwOn(422, ComponentsPricePointsSegmentsBulkJson422Error2Error, 'Unprocessable Entity (WebDAV)');
    return req.callAsJson(listSegmentsResponseSchema, requestOptions);
  }
}
