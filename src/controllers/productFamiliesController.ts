...
import {
  ...
  listProductsIncludeEnumSchema,
} from '../models/listProductsIncludeEnum';
import {
...
export class ProductFamiliesController extends BaseController {
   ...
   *
   * @param productFamilyId                                             The Chargify id of
   *                                                                                               the product family
   ...
   *                                                                                               products with
   *                                                                                               matching
   *                                                                                               use_site_exchange_ra
   *                                                                                               te based on provided
   *                                                                                               value (refers to
   *                                                                                               default price point).
   *                                                                                               Use in query
   *                                                                                               `filter[use_site_exc
  ...
  async listProductsForProductFamily(
    ...
    const mapped = req.prepareArgs({
      ...
      include: [include, optional(listProductsIncludeEnumSchema)],
      filterPrepaidProductPricePointProductPricePointId: [
        filterPrepaidProductPricePointProductPricePointId,
        optional(includeNotNullEnumSchema),
      ],
   ...
   *                                             date_field. Returns products with a timestamp at or after midnight (12:
   *                                             00:00 AM) in your site’s time zone on the date specified.
   * @param endDate        The end date (format YYYY-MM-DD) with which to filter the date_field.
   *                                             Returns products with a timestamp up to and including 11:59:59PM in
   ...
   *                                             filter the date_field. Returns products with a timestamp at or after
   ...
   *                                             filter the date_field. Returns products with a timestamp at or before
   *                                             exact time provided in query. You can specify timezone in query -
   *                                             otherwise your site's time zone will be used. If provided, this
