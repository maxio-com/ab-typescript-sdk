...
} from '../errors/subscriptionsRetryJson422Error';
import {
  CancellationRequest,
...
import {
  ...
  resumptionChargeEnumSchema,
} from '../models/resumptionChargeEnum';
import {
...
export class SubscriptionStatusController extends BaseController {
  ...
  async retrySubscription(
    ...
    req.throwOn(422, SubscriptionsRetryJson422Error, 'Unprocessable Entity (WebDAV)');
   ...
   *
   * @param subscriptionId                        The Chargify id of the subscription
   * @param calendarBillingResumptionCharge       (For calendar billing subscriptions only)
   *                                                                      The way that the resumed subscription's
  ...
  async resumeSubscription(
    ...
    const mapped = req.prepareArgs({
      ...
      calendarBillingResumptionCharge: [
        calendarBillingResumptionCharge,
        optional(resumptionChargeEnumSchema),
      ],
    });
