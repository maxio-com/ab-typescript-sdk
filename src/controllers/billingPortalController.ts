...
} from '../errors/portalCustomersManagementLinkJson429Error';
import { AutoInviteEnum, autoInviteEnumSchema } from '../models/autoInviteEnum';
import {
  CustomerResponse,
...
export class BillingPortalController extends BaseController {
   ...
   * @param autoInvite  When set to 1, an Invitation email will be sent to the Customer.  When set
   *                                      to 0, or not sent, an email will not be sent. Use in query: `auto_invite=1`.
  ...
  async enableBillingPortalForCustomer(
    ...
    const mapped = req.prepareArgs({
      ...
      autoInvite: [autoInvite, optional(autoInviteEnumSchema)],
    });
  ...
  async readBillingPortalLink(
    ...
    req.throwOn(422, ErrorListResponseError, 'Unprocessable Entity (WebDAV)');
    req.throwOn(429, PortalCustomersManagementLinkJson429Error, 'Too Many Requests');
