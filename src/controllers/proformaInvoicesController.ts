...
} from '../errors/subscriptionsProformaInvoicesJson400Error';
import {
  SubscriptionsProformaInvoicesPreviewJson400Error,
} from '../errors/subscriptionsProformaInvoicesPreviewJson400Error';
import {
...
export class ProformaInvoicesController extends BaseController {
  ...
  async createSignupProformaInvoice(
    ...
    req.header('Content-Type', 'application/json');
    req.json(mapped.body);
    req.throwOn(400, SubscriptionsProformaInvoicesJson400Error, 'Bad Request');
    req.throwOn(403, ApiError, 'Forbidden');
  ...
  async previewSignupProformaInvoice(
    ...
    req.json(mapped.body);
    req.throwOn(400, SubscriptionsProformaInvoicesPreviewJson400Error, 'Bad Request');
    req.throwOn(403, ApiError, 'Forbidden');
    req.throwOn(422, ErrorMapResponseError, 'Unprocessable Entity (WebDAV)');
