...
} from '../errors/subscriptionGroupsJson422Error';
import {
  SubscriptionGroupsJson422Error2Error,
} from '../errors/subscriptionGroupsJson422Error2Error';
import {
  SubscriptionGroupsSignupJson422Error,
} from '../errors/subscriptionGroupsSignupJson422Error';
import {
...
export class SubscriptionGroupsController extends BaseController {
  ...
  async signupWithSubscriptionGroup(
    ...
    req.throwOn(422, SubscriptionGroupsSignupJson422Error, 'Unprocessable Entity (WebDAV)');
  ...
  async createSubscriptionGroup(
    ...
    req.header('Content-Type', 'application/json');
    req.json(mapped.body);
    req.throwOn(422, SubscriptionGroupsJson422Error, 'Unprocessable Entity (WebDAV)');
  ...
  async updateSubscriptionGroupMembers(
    ...
    req.json(mapped.body);
    req.appendTemplatePath`/subscription_groups/${mapped.uid}.json`;
    req.throwOn(422, SubscriptionGroupsJson422Error2Error, 'Unprocessable Entity (WebDAV)');
    return req.callAsJson(subscriptionGroupResponseSchema, requestOptions);
  }
