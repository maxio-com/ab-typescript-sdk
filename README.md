...
```ts
npm install advanced-billing-sdk@0.0.5
```

For additional package details, see the [Npm page for the advanced-billing-sdk@0.0.5 npm](https://www.npmjs.com/package/advanced-billing-sdk/v/0.0.5).
